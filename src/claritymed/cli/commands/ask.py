...
def ask(
    ...
    emergency_sensitivity: CLIEmergencySensitivity | None = typer.Option(
        ...
        help=(
            ...
            "strict | balanced | lenient. To disable the gate entirely, set "
            "CLARITYMED_FORCE_EMERGENCY_GATE=off (master env switch — "
            "downgrades to 'lenient' at runtime) or write "
